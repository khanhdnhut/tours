...
define("CITIES_PER_PAGE_DEFAULT", 10);
define("HOTELS_PER_PAGE_DEFAULT", 10);
define("RESTAURANTS_PER_PAGE_DEFAULT", 10);
define("SHOPPINGS_PER_PAGE_DEFAULT", 10);
define("INTERNALFLIGHTS_PER_PAGE_DEFAULT", 10);
define("INTERNATIONALFLIGHTS_PER_PAGE_DEFAULT", 10);
define("ACTIVITIES_PER_PAGE_DEFAULT", 10);
define("NIGHTLIFES_PER_PAGE_DEFAULT", 10);
define("EATS_PER_PAGE_DEFAULT", 10);
define("ATTRACTIONS_PER_PAGE_DEFAULT", 10);
define("TAGS_PER_PAGE_DEFAULT", 10);
define("TAGS_PER_PAGE_AJAX_DEFAULT", 10);
define("DESTINATIONS_PER_PAGE_DEFAULT", 10);
define("STYLES_PER_PAGE_DEFAULT", 10);
define("TYPES_PER_PAGE_DEFAULT", 10);
