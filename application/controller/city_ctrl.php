    ...
    public function addNew()
    {
        if (in_array(Auth::getCapability(), array(CAPABILITY_ADMINISTRATOR))) {
            ...
            if (isset($_POST['ajax']) && !is_null($_POST['ajax'])) {
                ...
                $this->view->renderAdmin(RENDER_VIEW_CITY_ADD_NEW);
            }
        } else {
            $this->login();
        }
        ...
        if (in_array(Auth::getCapability(), array(CAPABILITY_ADMINISTRATOR))) {
            ...
            if (isset($this->para->term_taxonomy_id)) {
                ...
                if (isset($term_taxonomy_id) && !is_null($term_taxonomy_id)) {
                    ...
                    $this->view->renderAdmin(RENDER_VIEW_CITY_EDIT, TRUE);
                }
            } else {
                header('location: ' . URL . CONTEXT_PATH_CITY_INDEX);
            }
        } else {
            $this->login();
        }
        ...
        if (in_array(Auth::getCapability(), array(CAPABILITY_ADMINISTRATOR))) {
            ...
            if (isset($this->para->term_taxonomy_id)) {
                ...
                if (isset($term_taxonomy_id) && !is_null($term_taxonomy_id)) {
                    ...
                    $this->view->renderAdmin(RENDER_VIEW_CITY_INFO, TRUE);
                }
            } else {
                header('location: ' . URL . CONTEXT_PATH_CITY_INDEX);
            }
