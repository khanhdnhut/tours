...
if (isset($this->activityBO) && $this->activityBO != NULL) {
    ...
    <h1>
        <?php echo EDIT_PROFILE_OF_TITLE . " " . ACTIVITY_TITLE; ?> "<strong><?php
            if (isset($this->activityBO->post_title)) {
                echo $this->activityBO->post_title;
            }

            ?></strong>"
        <a class="page-title-action" ajaxlink="<?php echo URL . CONTEXT_PATH_ACTIVITY_ADD_NEW; ?>" ajaxtarget=".wrap" href="#" onclick="openAjaxLink(this)" ><?php echo ADD_NEW_TITLE; ?></a>
    </h1>
    ...
    <form id="form-your-profile" novalidate="novalidate"  method="POST" enctype="multipart/form-data" action="<?php echo URL . CONTEXT_PATH_ACTIVITY_EDIT_INFO; ?>">
        <input type="hidden" value="update" name="action">
        <input type="hidden" value="<?php
        if (isset($this->activityBO->ID)) {
            echo htmlspecialchars($this->activityBO->ID);
        }
        ...
        <table class="form-table">
            <tbody>
                ...
                <tr class="activity-country-id-wrap">
                    ...
                    <th><label for="city_id"><?php echo ACTIVITY_CITY_TITLE; ?> <span style="color: red;" class="description"><?php echo LABEL_REQUIRED; ?></label></th>
                    <td>
                ...
                <tr class="activity-image-wrap">
                    ...
                    <td colspan="3">
                        ...
                        <p class="images"><?php echo ACTIVITY_IMAGES_DESCRIPTION_DESC; ?></p>
                    </td>
                </tr>
        ...
        <p class="submit"><input type="submit" value="<?php echo LABEL_UPDATE_ACTIVITY; ?>" class="button button-primary" id="submit" name="submit"></p>
    </form>
    <script>
        window.scrollTo(0, 0);
        ...
        function validateFormEditActivity() {
            ...
            if (jQuery("#image").val() != "") {
                ...
                if (validExts.indexOf(fileExt) < 0) {
                    noticeError("<?php echo ERROR_ACTIVITY_IMAGE_INVALID; ?>");
                    return false;
                }
            }
            return true;
        ...
        jQuery("#form-your-profile").submit(function (e) {
            ...
            if (!validateFormEditActivity()) {
                return;
            }
            var name = jQuery('#form-your-profile input[name="post_title"]').val();
            if (confirm('<?php echo CONFIRM_EDIT_INFO_ACTIVITY; ?>' + name + '<?php echo CONFIRM_EDIT_INFO_CANCEL_OK; ?>')) {
