                ...
                <div class="article-tools clearfix">                    
                    <div class="size-1 extravote">
                        <span itemtype="/AggregateRating" itemscope="" itemprop="aggregateRating" class="extravote-stars">
                            ...
                            if (isset($this->activityBO->current_rating) && is_numeric($this->activityBO->current_rating)) {
                                echo $this->activityBO->current_rating * 100 / 5;
                            } else {
                                echo 0;
                            }
                            ...
                            ?>%;" class="current-rating" id="rating_623_0"><?php
                                  if (isset($this->activityBO->current_rating) && is_numeric($this->activityBO->current_rating)) {
                                      echo $this->activityBO->current_rating;
                                  } else {
                                      echo 0;
                                  }
                        ...
                        <span id="extravote_623_0" class="extravote-info">Rating <?php
                            ...
                            if (isset($this->activityBO->vote_times)) {
                                echo $this->activityBO->vote_times;
                            } else {
                                echo 0;
                            }
                    ...
                    <p>
                        ...
                        ?>" rel="lightbox[623]" href="" class="thumbnail" style="">
                            ...
                            if (isset($this->activityBO->image_url)) {
                                echo URL . $this->activityBO->image_url;
                            }

                            ?>" class="maps img-border" alt="Sofitel Legend Metropole Hanoi Activity">
                        </a>
                    </p>
                    <p><?php
                        if (isset($this->activityBO->post_content)) {
                            echo $this->activityBO->post_content;
//                            echo str_replace("\n", "<br>", $this->activityBO->post_content);
                        }
