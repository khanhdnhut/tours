...
if (isset($this->attractionBO) && $this->attractionBO != NULL) {
    ...
    <h1>
        <?php echo EDIT_PROFILE_OF_TITLE . " " . ATTRACTION_TITLE; ?> "<strong><?php
            if (isset($this->attractionBO->name)) {
                echo $this->attractionBO->name;
            }

            ?></strong>"
        <a class="page-title-action" ajaxlink="<?php echo URL . CONTEXT_PATH_ATTRACTION_ADD_NEW; ?>" ajaxtarget=".wrap" href="#" onclick="openAjaxLink(this)" ><?php echo ADD_NEW_TITLE; ?></a>
    </h1>
    ...
    <form id="form-your-profile" novalidate="novalidate"  method="POST" enctype="multipart/form-data" action="<?php echo URL . CONTEXT_PATH_ATTRACTION_EDIT_INFO; ?>">
        <input type="hidden" value="update" name="action">
        <input type="hidden" value="<?php
        if (isset($this->attractionBO->term_taxonomy_id)) {
            echo htmlspecialchars($this->attractionBO->term_taxonomy_id);
        }
            ...
            <tbody>
                <tr class="attraction-name-wrap">
                    ...
                    <td>
                        ...
                        ?>" id="name" name="name">
                        <p class="description"><?php echo ATTRACTION_NAME_DESC; ?></p>
                    </td>
                </tr>
                <tr class="attraction-slug-wrap">
                    ...
                    <td>
                        ...
                        ?>" id="slug" name="slug">
                        <p class="description"><?php echo ATTRACTION_SLUG_DESC; ?></p>
                    </td>
                </tr>

                <tr class="attraction-country-wrap"><th><label for="country"><?php echo ATTRACTION_PARENT_TITLE; ?> <span style="color: red;" class="description"><?php echo LABEL_REQUIRED; ?></span></label></th>
                    <td>
                        ...
                        <p class="description"><?php echo ATTRACTION_PARENT_DESC; ?></p>
                    </td>
                </tr>
                <tr class="attraction-city-wrap"><th><label for="city"><?php echo ATTRACTION_CITY_TITLE; ?> </label></th>
                    <td>
                ...
                <tr class="attraction-destination-wrap"><th><label for="destination"><?php echo ATTRACTION_DESTINATION_TITLE; ?> </label></th>
                    <td>
                ...
                <tr class="attraction-parent-wrap"><th><label for="parent"><?php echo PARENT_TITLE; ?> <span style="color: red;" class="description"><?php echo LABEL_REQUIRED; ?></span></label></th>
                    <td>
                        <select id="parent" name="parent" >
                            ...
                            if (isset($this->parentList) && is_a($this->parentList, "SplDoublyLinkedList")) {
                                ...
                                foreach ($this->parentList as $value) {
                                    ...
                                    if ($value->term_taxonomy_id != $this->attractionBO->term_taxonomy_id &&
                                        $value->parent != $this->attractionBO->term_taxonomy_id) {
                ...
                <tr class="attraction-description-wrap">
                    ...
                    <td>
                        ...
                        <p class="description"><?php echo ATTRACTION_DESCRIPTION_DESC; ?></p>
                    </td>
                </tr>
                ...
                <tr class="images-wrap">
                    ...
                    <td>
                        ...
                        <p class="images"  style="float: left; width: 100%; margin-bottom: 30px;"><?php echo ATTRACTION_IMAGES_DESCRIPTION_DESC; ?></p>
        ...
        <p class="submit"><input type="submit" value="<?php echo LABEL_UPDATE_ATTRACTION; ?>" class="button button-primary" id="submit" name="submit"></p>
    </form>
    <script>
        ...
        function validateFormEditAttraction() {
        ...
        jQuery("#form-your-profile").submit(function (e) {
            e.preventDefault();
            if (!validateFormEditAttraction()) {
                return;
            }
            var name = jQuery('#form-your-profile input[name="name"]').val();
            if (confirm('<?php echo CONFIRM_EDIT_INFO_ATTRACTION; ?>' + name + '<?php echo CONFIRM_EDIT_INFO_CANCEL_OK; ?>')) {
