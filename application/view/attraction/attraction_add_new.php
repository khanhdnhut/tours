...
<h1>
    <?php echo ADD_NEW_ATTRACTION_LABEL; ?>
</h1>
<div id="message_notice">
    <?php $this->renderFeedbackMessages(); ?>
</div>
<form id="form-your-profile" novalidate="novalidate"  method="POST" enctype="multipart/form-data" action="<?php echo URL . CONTEXT_PATH_ATTRACTION_ADD_NEW; ?>">
        ...
        <tbody>
            ...
            <tr class="attraction-country-wrap"><th><label for="country"><?php echo ATTRACTION_PARENT_TITLE; ?> <span style="color: red;" class="description"><?php echo LABEL_REQUIRED; ?></span></label></th>
                <td>
                    ...
                    <span class="description"><?php echo ATTRACTION_PARENT_DESC; ?></span>
                </td>
            </tr>
            ...
            <tr class="attraction-parent-wrap"><th><label for="parent"><?php echo PARENT_TITLE; ?> </label></th>
                <td>
            ...
            <tr class="images-wrap">
                ...
                <td>
                    ...
                    <p class="images"><?php echo ATTRACTION_IMAGES_DESCRIPTION_DESC; ?></p>
                </td>
            </tr>
    ...
    <p class="submit"><input type="submit" value="<?php echo ADD_NEW_ATTRACTION_LABEL; ?>" class="button button-primary" id="submit" name="submit"></p>
</form>
<script>
                        window.scrollTo(0, 0);
                        ...
                        function validateFormAddNewAttraction() {
                        ...
                        jQuery("#form-your-profile").submit(function (e) {
                            ...
                            if (!validateFormAddNewAttraction()) {
                                return;
                            }
                            var name = jQuery('#form-your-profile input[name="name"]').val();
                            if (confirm('<?php echo CONFIRM_ADD_NEW_ATTRACTION; ?>' + name + '<?php echo CONFIRM_EDIT_INFO_CANCEL_OK; ?>')) {
