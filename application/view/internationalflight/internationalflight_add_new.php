...
<h1>
    <?php echo ADD_NEW_INTERNATIONALFLIGHT_LABEL; ?>
</h1>
<div id="message_notice">
    <?php $this->renderFeedbackMessages(); ?>
</div>
<form id="form-your-profile" novalidate="novalidate"  method="POST" enctype="multipart/form-data" action="<?php echo URL . CONTEXT_PATH_INTERNATIONALFLIGHT_ADD_NEW; ?>">
    ...
    <table class="form-table">
        <tbody>
            ...
            <tr class="internationalflight-city-id-wrap">
                ...
                <th colspan="1"><label for="image"><?php echo INTERNATIONALFLIGHT_IMAGE_TITLE; ?> <span style="color: red;" class="description"><?php echo LABEL_TYPE_IMAGE_REQUIRED; ?></label></th>
                <td colspan="3">                    
    ...
    <p class="submit"><input type="submit" value="<?php echo ADD_NEW_INTERNATIONALFLIGHT_LABEL; ?>" class="button button-primary" id="submit" name="submit"></p>
</form>
<script>
    window.scrollTo(0, 0);
    ...
    function validateFormAddNewInternationalflight() {
        ...
        if (jQuery("#image").val() == "") {
            noticeError("<?php echo ERROR_INTERNATIONALFLIGHT_IMAGE_EMPTY; ?>");
            return false;
        } else {
    ...
    jQuery("#form-your-profile").submit(function (e) {
        ...
        if (!validateFormAddNewInternationalflight()) {
            return;
        }
        var name = jQuery('#form-your-profile input[name="post_title"]').val();
        if (confirm('<?php echo CONFIRM_ADD_NEW_INTERNATIONALFLIGHT; ?>' + name + '<?php echo CONFIRM_EDIT_INFO_CANCEL_OK; ?>')) {
