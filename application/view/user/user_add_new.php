...
<h1>
    <?php echo ADD_NEW_USER_LABEL; ?>
</h1>
<div id="message_notice">
    <?php $this->renderFeedbackMessages(); ?>
</div>
<form id="form-your-profile" novalidate="novalidate"  method="POST" enctype="multipart/form-data" action="<?php echo URL . CONTEXT_PATH_USER_ADD_NEW; ?>">
    ...
    <table class="form-table">
        <tbody>
            <tr class="user-user-login-wrap">
                <th>
                    <label for="user_login"><?php echo USER_NAME; ?> <span style="color: red;" class="description"><?php echo LABEL_REQUIRED; ?></span></label>
                </th>
                <td>
                    <input type="text" class="regular-text" value="<?php
                    if (isset($this->para->user_login)) {
                        echo htmlspecialchars($this->para->user_login);
                    }
    ...
    <table class="form-table">
        <tbody>
            <tr class="user-pass1-wrap" id="password">
                <th>
                    <label for="pass1-text"><?php echo PASSWORD; ?> <span style="color: red;" class="description"><?php echo LABEL_REQUIRED; ?></span></label>
                </th>
                <td>
    ...
    <p class="submit"><input type="submit" value="<?php echo ADD_NEW_USER_LABEL; ?>" class="button button-primary" id="submit" name="submit"></p>
</form>
<script>
    window.scrollTo(0, 0);
    ...
    function validateFormAddNewUser() {
        if (jQuery('#form-your-profile input[name="user_login"]').val() == "") {
            noticeError("<?php echo ERROR_USERNAME_IS_EMPTY; ?>");
            return false;
        }
        ...
        if (jQuery('#form-your-profile input[name="pass1-text"]').val() == "" ||
                jQuery('#form-your-profile input[name="pass1"]').val() == "") {
            noticeError("<?php echo ERROR_PASSWORD_IS_EMPTY; ?>");
            return false;
        }
        return true;
    }
