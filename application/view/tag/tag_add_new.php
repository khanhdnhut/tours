...
<h1>
    <?php echo ADD_NEW_TAG_LABEL; ?>
</h1>
<div id="message_notice">
    <?php $this->renderFeedbackMessages(); ?>
</div>
<form id="form-your-profile" novalidate="novalidate"  method="POST" enctype="multipart/form-data" action="<?php echo URL . CONTEXT_PATH_TAG_ADD_NEW; ?>">
        ...
        <tbody>
            <tr class="tag-name-wrap">
                ...
                <td>
                    ...
                    ?>" id="name" name="name">
                    <p class="description"><?php echo TAG_NAME_DESC; ?></p>
                </td>
            </tr>
            ...
            <tr class="tag-slug-wrap">
                ...
                <td>
                    ...
                    ?>" id="slug" name="slug">
                    <p class="description"><?php echo TAG_SLUG_DESC; ?></p>
                </td>
            </tr>

            <tr class="tag-parent-wrap"><th><label for="parent"><?php echo TAG_PERENT_TITLE; ?></label></th>
                <td>
                    ...
                    <span class="description"><?php echo TAG_PERENT_DESC; ?></span>
                </td>
            </tr>
            ...
            <tr class="tag-description-wrap">
                ...
                <td>
                    ...
                    <p class="description"><?php echo TAG_DESCRIPTION_DESC; ?></p>
                </td>
            </tr>
        </tbody>
    </table>

    <p class="submit"><input type="submit" value="<?php echo ADD_NEW_TAG_LABEL; ?>" class="button button-primary" id="submit" name="submit"></p>
</form>
<script>
    window.scrollTo(0, 0);
    ...
    jQuery("#form-your-profile").submit(function (e) {
        ...
        if (!validateFormAddNewTag()) {
            return;
        }
        var name = jQuery('#form-your-profile input[name="name"]').val();
        if (confirm('<?php echo CONFIRM_ADD_NEW_TAG; ?>' + name + '<?php echo CONFIRM_EDIT_INFO_CANCEL_OK; ?>')) {
