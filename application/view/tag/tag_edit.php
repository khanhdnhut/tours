...
if (isset($this->tagBO) && $this->tagBO != NULL) {
    ...
    <h1>
        <?php echo EDIT_PROFILE_OF_TITLE . " " . TAG_TITLE; ?> "<strong><?php
    ...
    <form id="form-your-profile" novalidate="novalidate"  method="POST" enctype="multipart/form-data" action="<?php echo URL . CONTEXT_PATH_TAG_EDIT_INFO; ?>">
            ...
            <tbody>
                ...
                <tr class="tag-parent-wrap"><th><label for="parent"><?php echo TAG_PERENT_TITLE; ?> </label></th>
                    <td>
                        ...
                        <p class="description"><?php echo TAG_PERENT_DESC; ?></p>
                    </td>
                </tr>
        ...
        <p class="submit"><input type="submit" value="<?php echo LABEL_UPDATE_TAG; ?>" class="button button-primary" id="submit" name="submit"></p>
    </form>
    <script>
        window.scrollTo(0, 0);
        ...
        jQuery("#form-your-profile").submit(function (e) {
            ...
            if (confirm('<?php echo CONFIRM_EDIT_INFO_TAG; ?>' + name + '<?php echo CONFIRM_EDIT_INFO_CANCEL_OK; ?>')) {
