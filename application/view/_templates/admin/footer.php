...
<div role="contentinfo" id="wpfooter">
    <p class="alignleft" id="footer-left">
        <span id="footer-thankyou"><?php echo ADMIN_FOOTER_THANKYOU_TITLE; ?><a href="<?php echo URL; ?>"><?php echo WEBSITE_NAME; ?></a>.</span> </p>
    <p class="alignright" id="footer-upgrade"><?php echo VERSION_TITLE; ?></p>
    <div class="clear"></div>
</div>
