    ...
    <div class="ja-content-main clearfix" id="ja-content-main" style="padding-bottom: 10px;">
        ...
        if (isset($this->eatBO) && $this->eatBO != NULL) {
            ...
            <div itemtype="http://schema.org/Article" itemscope="" class="item-page">
                <h1 class="contentheading2 clearfix"><?php echo $this->eatBO->name; ?></h1>
            ...
            <div class="article-tools clearfix">                    
                <div class="size-1 extravote">
                    <span itemtype="/AggregateRating" itemscope="" itemprop="aggregateRating" class="extravote-stars">
                        ...
                        if (isset($this->eatBO->current_rating) && is_numeric($this->eatBO->current_rating)) {
                            echo $this->eatBO->current_rating * 100 / 5;
                        } else {
                            echo 0;
                        }
                        ...
                        ?>%;" class="current-rating" id="rating_623_0"><?php
                              if (isset($this->eatBO->current_rating) && is_numeric($this->eatBO->current_rating)) {
                                  echo $this->eatBO->current_rating;
                              } else {
                                  echo 0;
                              }
            ...
            <?php
            if (isset($this->eatBO->post_content_1)) {
                echo str_replace("\n", "<br>", $this->eatBO->post_content_1);
            }
            ...
            if (isset($this->eatBO->post_content_2)) {
                echo str_replace("\n", "<br>", $this->eatBO->post_content_2);
            }
