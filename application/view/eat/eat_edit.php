...
if (isset($this->eatBO) && $this->eatBO != NULL) {
    ...
    <h1>
        <?php echo EDIT_PROFILE_OF_TITLE . " " . EAT_TITLE; ?> "<strong><?php
            if (isset($this->eatBO->name)) {
                echo $this->eatBO->name;
            }

            ?></strong>"
        <a class="page-title-action" ajaxlink="<?php echo URL . CONTEXT_PATH_EAT_ADD_NEW; ?>" ajaxtarget=".wrap" href="#" onclick="openAjaxLink(this)" ><?php echo ADD_NEW_TITLE; ?></a>
    </h1>
    ...
    <form id="form-your-profile" novalidate="novalidate"  method="POST" enctype="multipart/form-data" action="<?php echo URL . CONTEXT_PATH_EAT_EDIT_INFO; ?>">
        <input type="hidden" value="update" name="action">
        <input type="hidden" value="<?php
        if (isset($this->eatBO->term_taxonomy_id)) {
            echo htmlspecialchars($this->eatBO->term_taxonomy_id);
        }
            ...
            <tbody>
                ...
                <tr class="eat-country-wrap"><th><label for="country"><?php echo EAT_PARENT_TITLE; ?> <span style="color: red;" class="description"><?php echo LABEL_REQUIRED; ?></span></label></th>
                    <td>
                        ...
                        <p class="description"><?php echo EAT_PARENT_DESC; ?></p>
                    </td>
                </tr>
                ...
                <tr class="eat-parent-wrap"><th><label for="parent"><?php echo PARENT_TITLE; ?> <span style="color: red;" class="description"><?php echo LABEL_REQUIRED; ?></span></label></th>
                    <td>
                        <select id="parent" name="parent" >
                            ...
                            if (isset($this->parentList) && is_a($this->parentList, "SplDoublyLinkedList")) {
                                ...
                                foreach ($this->parentList as $value) {
                                    ...
                                    if ($value->term_taxonomy_id != $this->eatBO->term_taxonomy_id &&
                                        $value->parent != $this->eatBO->term_taxonomy_id) {
                ...
                <tr class="images-wrap">
                    ...
                    <td>
                        ...
                        <p class="images"  style="float: left; width: 100%; margin-bottom: 30px;"><?php echo EAT_IMAGES_DESCRIPTION_DESC; ?></p>
        ...
        <p class="submit"><input type="submit" value="<?php echo LABEL_UPDATE_EAT; ?>" class="button button-primary" id="submit" name="submit"></p>
    </form>
    <script>
        ...
        jQuery("#form-your-profile").submit(function (e) {
            e.preventDefault();
            if (!validateFormEditEat()) {
                return;
            }
            var name = jQuery('#form-your-profile input[name="name"]').val();
            if (confirm('<?php echo CONFIRM_EDIT_INFO_EAT; ?>' + name + '<?php echo CONFIRM_EDIT_INFO_CANCEL_OK; ?>')) {
