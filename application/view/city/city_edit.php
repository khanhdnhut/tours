...
if (isset($this->cityBO) && $this->cityBO != NULL) {
    ...
    <h1>
        <?php echo EDIT_PROFILE_OF_TITLE . " " . CITY_TITLE; ?> "<strong><?php
    ...
    <form id="form-your-profile" novalidate="novalidate"  method="POST" enctype="multipart/form-data" action="<?php echo URL . CONTEXT_PATH_CITY_EDIT_INFO; ?>">
        <input type="hidden" value="update" name="action">
        <input type="hidden" value="<?php
        if (isset($this->cityBO->term_taxonomy_id)) {
            echo htmlspecialchars($this->cityBO->term_taxonomy_id);
        }
            ...
            <tbody>
                <tr class="city-name-wrap">
                    ...
                    <td>
                        ...
                        ?>" id="name" name="name">
                        <p class="description"><?php echo CITY_NAME_DESC; ?></p>
                    </td>
                </tr>
                <tr class="city-slug-wrap">
                    ...
                    <td>
                        ...
                        ?>" id="slug" name="slug">
                        <p class="description"><?php echo CITY_SLUG_DESC; ?></p>
                    </td>
                </tr>
                ...
                <tr class="images-wrap">
                    ...
                    <td>
                        ...
                        <p class="images"  style="float: left; width: 100%; margin-bottom: 30px;"><?php echo CITY_IMAGES_DESCRIPTION_DESC; ?></p>
        ...
        <p class="submit"><input type="submit" value="<?php echo LABEL_UPDATE_CITY; ?>" class="button button-primary" id="submit" name="submit"></p>
    </form>
    <script>
        ...
        jQuery("#form-your-profile").submit(function (e) {
            e.preventDefault();
            if (!validateFormEditCity()) {
                return;
            }
            var name = jQuery('#form-your-profile input[name="name"]').val();
            if (confirm('<?php echo CONFIRM_EDIT_INFO_CITY; ?>' + name + '<?php echo CONFIRM_EDIT_INFO_CANCEL_OK; ?>')) {
