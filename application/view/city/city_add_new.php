...
<h1>
    <?php echo ADD_NEW_CITY_LABEL; ?>
</h1>
<div id="message_notice">
    <?php $this->renderFeedbackMessages(); ?>
</div>
<form id="form-your-profile" novalidate="novalidate"  method="POST" enctype="multipart/form-data" action="<?php echo URL . CONTEXT_PATH_CITY_ADD_NEW; ?>">
        ...
        <tbody>
            ...
            <tr class="city-parent-wrap"><th><label for="parent"><?php echo CITY_PERENT_TITLE; ?></label></th>
                <td>
                    ...
                    <span class="description"><?php echo CITY_PERENT_DESC; ?></span>
                </td>
            </tr>
...
<script>
    ...
    jQuery("#form-your-profile").submit(function (e) {
        ...
        if (!validateFormAddNewCity()) {
            return;
        }
        var name = jQuery('#form-your-profile input[name="name"]').val();
        if (confirm('<?php echo CONFIRM_ADD_NEW_CITY; ?>' + name + '<?php echo CONFIRM_EDIT_INFO_CANCEL_OK; ?>')) {
