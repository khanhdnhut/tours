                ...
                <div class="article-tools clearfix">                    
                    <div class="size-1 extravote">
                        <span itemtype="/AggregateRating" itemscope="" itemprop="aggregateRating" class="extravote-stars">
                            ...
                            if (isset($this->nightlifeBO->current_rating) && is_numeric($this->nightlifeBO->current_rating)) {
                                echo $this->nightlifeBO->current_rating * 100 / 5;
                            } else {
                                echo 0;
                            }
                            ...
                            ?>%;" class="current-rating" id="rating_623_0"><?php
                                  if (isset($this->nightlifeBO->current_rating) && is_numeric($this->nightlifeBO->current_rating)) {
                                      echo $this->nightlifeBO->current_rating;
                                  } else {
                                      echo 0;
                                  }
                        ...
                        <span id="extravote_623_0" class="extravote-info">Rating <?php
                            ...
                            if (isset($this->nightlifeBO->vote_times)) {
                                echo $this->nightlifeBO->vote_times;
                            } else {
                                echo 0;
                            }
                    ...
                    <p>
                        ...
                        ?>" rel="lightbox[623]" href="" class="thumbnail" style="">
                            ...
                            if (isset($this->nightlifeBO->image_url)) {
                                echo URL . $this->nightlifeBO->image_url;
                            }

                            ?>" class="maps img-border" alt="Sofitel Legend Metropole Hanoi Nightlife">
                        </a>
                    </p>
                    <p><?php
                        if (isset($this->nightlifeBO->post_content)) {
                            echo $this->nightlifeBO->post_content;
//                            echo str_replace("\n", "<br>", $this->nightlifeBO->post_content);
                        }
