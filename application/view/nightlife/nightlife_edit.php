...
if (isset($this->nightlifeBO) && $this->nightlifeBO != NULL) {
    ...
    <h1>
        <?php echo EDIT_PROFILE_OF_TITLE . " " . NIGHTLIFE_TITLE; ?> "<strong><?php
            if (isset($this->nightlifeBO->post_title)) {
                echo $this->nightlifeBO->post_title;
            }

            ?></strong>"
        <a class="page-title-action" ajaxlink="<?php echo URL . CONTEXT_PATH_NIGHTLIFE_ADD_NEW; ?>" ajaxtarget=".wrap" href="#" onclick="openAjaxLink(this)" ><?php echo ADD_NEW_TITLE; ?></a>
    </h1>
    ...
    <form id="form-your-profile" novalidate="novalidate"  method="POST" enctype="multipart/form-data" action="<?php echo URL . CONTEXT_PATH_NIGHTLIFE_EDIT_INFO; ?>">
        <input type="hidden" value="update" name="action">
        <input type="hidden" value="<?php
        if (isset($this->nightlifeBO->ID)) {
            echo htmlspecialchars($this->nightlifeBO->ID);
        }
        ...
        <table class="form-table">
            <tbody>
                ...
                <tr class="nightlife-country-id-wrap">
                    ...
                    <th><label for="city_id"><?php echo NIGHTLIFE_CITY_TITLE; ?> <span style="color: red;" class="description"><?php echo LABEL_REQUIRED; ?></label></th>
                    <td>
                ...
                <tr class="nightlife-image-wrap">
                    ...
                    <td colspan="3">
                        ...
                        <p class="images"><?php echo NIGHTLIFE_IMAGES_DESCRIPTION_DESC; ?></p>
                    </td>
                </tr>
        ...
        <p class="submit"><input type="submit" value="<?php echo LABEL_UPDATE_NIGHTLIFE; ?>" class="button button-primary" id="submit" name="submit"></p>
    </form>
    <script>
        window.scrollTo(0, 0);
        ...
        function validateFormEditNightlife() {
            ...
            if (jQuery("#image").val() != "") {
                ...
                if (validExts.indexOf(fileExt) < 0) {
                    noticeError("<?php echo ERROR_NIGHTLIFE_IMAGE_INVALID; ?>");
                    return false;
                }
            }
            return true;
        ...
        jQuery("#form-your-profile").submit(function (e) {
            ...
            if (!validateFormEditNightlife()) {
                return;
            }
            var name = jQuery('#form-your-profile input[name="post_title"]').val();
            if (confirm('<?php echo CONFIRM_EDIT_INFO_NIGHTLIFE; ?>' + name + '<?php echo CONFIRM_EDIT_INFO_CANCEL_OK; ?>')) {
