...
if (isset($this->restaurantBO) && $this->restaurantBO != NULL) {
    ...
    <h1>
        <?php echo EDIT_PROFILE_OF_TITLE . " " . RESTAURANT_TITLE; ?> "<strong><?php
            if (isset($this->restaurantBO->post_title)) {
                echo $this->restaurantBO->post_title;
            }

            ?></strong>"
        <a class="page-title-action" ajaxlink="<?php echo URL . CONTEXT_PATH_RESTAURANT_ADD_NEW; ?>" ajaxtarget=".wrap" href="#" onclick="openAjaxLink(this)" ><?php echo ADD_NEW_TITLE; ?></a>
    </h1>
    ...
    <form id="form-your-profile" novalidate="novalidate"  method="POST" enctype="multipart/form-data" action="<?php echo URL . CONTEXT_PATH_RESTAURANT_EDIT_INFO; ?>">
        <input type="hidden" value="update" name="action">
        <input type="hidden" value="<?php
        if (isset($this->restaurantBO->ID)) {
            echo htmlspecialchars($this->restaurantBO->ID);
        }
        ...
        <table class="form-table">
            <tbody>
                ...
                <tr class="restaurant-country-id-wrap">
                    ...
                    <th><label for="city_id"><?php echo RESTAURANT_CITY_TITLE; ?> <span style="color: red;" class="description"><?php echo LABEL_REQUIRED; ?></label></th>
                    <td>
                ...
                <tr class="restaurant-image-wrap">
                    ...
                    <td colspan="3">
                        ...
                        <p class="images"><?php echo RESTAURANT_IMAGES_DESCRIPTION_DESC; ?></p>
                    </td>
                </tr>
        ...
        <p class="submit"><input type="submit" value="<?php echo LABEL_UPDATE_RESTAURANT; ?>" class="button button-primary" id="submit" name="submit"></p>
    </form>
    <script>
        window.scrollTo(0, 0);
        ...
        function validateFormEditRestaurant() {
            ...
            if (jQuery("#image").val() != "") {
                ...
                if (validExts.indexOf(fileExt) < 0) {
                    noticeError("<?php echo ERROR_RESTAURANT_IMAGE_INVALID; ?>");
                    return false;
                }
            }
            return true;
        ...
        jQuery("#form-your-profile").submit(function (e) {
            ...
            if (!validateFormEditRestaurant()) {
                return;
            }
            var name = jQuery('#form-your-profile input[name="post_title"]').val();
            if (confirm('<?php echo CONFIRM_EDIT_INFO_RESTAURANT; ?>' + name + '<?php echo CONFIRM_EDIT_INFO_CANCEL_OK; ?>')) {
