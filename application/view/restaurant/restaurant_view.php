                ...
                <div class="article-tools clearfix">                    
                    <div class="size-1 extravote">
                        <span itemtype="/AggregateRating" itemscope="" itemprop="aggregateRating" class="extravote-stars">
                            ...
                            if (isset($this->restaurantBO->current_rating) && is_numeric($this->restaurantBO->current_rating)) {
                                echo $this->restaurantBO->current_rating * 100 / 5;
                            } else {
                                echo 0;
                            }
                            ...
                            ?>%;" class="current-rating" id="rating_623_0"><?php
                                  if (isset($this->restaurantBO->current_rating) && is_numeric($this->restaurantBO->current_rating)) {
                                      echo $this->restaurantBO->current_rating;
                                  } else {
                                      echo 0;
                                  }
                        ...
                        <span id="extravote_623_0" class="extravote-info">Rating <?php
                            ...
                            if (isset($this->restaurantBO->vote_times)) {
                                echo $this->restaurantBO->vote_times;
                            } else {
                                echo 0;
                            }
                    ...
                    <p>
                        ...
                        ?>" rel="lightbox[623]" href="" class="thumbnail" style="">
                            ...
                            if (isset($this->restaurantBO->image_url)) {
                                echo URL . $this->restaurantBO->image_url;
                            }

                            ?>" class="maps img-border" alt="Sofitel Legend Metropole Hanoi Restaurant">
                        </a>
                    </p>
                    <p><?php
                        if (isset($this->restaurantBO->post_content)) {
                            echo $this->restaurantBO->post_content;
//                            echo str_replace("\n", "<br>", $this->restaurantBO->post_content);
                        }
