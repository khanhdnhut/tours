                ...
                <div class="article-tools clearfix">                    
                    <div class="size-1 extravote">
                        <span itemtype="/AggregateRating" itemscope="" itemprop="aggregateRating" class="extravote-stars">
                            ...
                            if (isset($this->internalflightBO->current_rating) && is_numeric($this->internalflightBO->current_rating)) {
                                echo $this->internalflightBO->current_rating * 100 / 5;
                            } else {
                                echo 0;
                            }
                            ...
                            ?>%;" class="current-rating" id="rating_623_0"><?php
                                  if (isset($this->internalflightBO->current_rating) && is_numeric($this->internalflightBO->current_rating)) {
                                      echo $this->internalflightBO->current_rating;
                                  } else {
                                      echo 0;
                                  }
                        ...
                        <span id="extravote_623_0" class="extravote-info">Rating <?php
                            ...
                            if (isset($this->internalflightBO->vote_times)) {
                                echo $this->internalflightBO->vote_times;
                            } else {
                                echo 0;
                            }
                    ...
                    <p>
                        ...
                        ?>" rel="lightbox[623]" href="" class="thumbnail" style="">
                            ...
                            if (isset($this->internalflightBO->image_url)) {
                                echo URL . $this->internalflightBO->image_url;
                            }

                            ?>" class="maps img-border" alt="Sofitel Legend Metropole Hanoi Internalflight">
                        </a>
                    </p>
                    <p><?php
                        if (isset($this->internalflightBO->post_content)) {
                            echo $this->internalflightBO->post_content;
//                            echo str_replace("\n", "<br>", $this->internalflightBO->post_content);
                        }
