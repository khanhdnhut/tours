<?php
if (isset($this->internalflightBO) && $this->internalflightBO != NULL) {
    ...
    <h1>
        <?php echo EDIT_PROFILE_OF_TITLE . " " . INTERNALFLIGHT_TITLE; ?> "<strong><?php
            if (isset($this->internalflightBO->post_title)) {
                echo $this->internalflightBO->post_title;
            }

            ?></strong>"
        <a class="page-title-action" ajaxlink="<?php echo URL . CONTEXT_PATH_INTERNALFLIGHT_ADD_NEW; ?>" ajaxtarget=".wrap" href="#" onclick="openAjaxLink(this)" ><?php echo ADD_NEW_TITLE; ?></a>
    </h1>
    ...
    <form id="form-your-profile" novalidate="novalidate"  method="POST" enctype="multipart/form-data" action="<?php echo URL . CONTEXT_PATH_INTERNALFLIGHT_EDIT_INFO; ?>">
        <input type="hidden" value="update" name="action">
        <input type="hidden" value="<?php
        if (isset($this->internalflightBO->ID)) {
            echo htmlspecialchars($this->internalflightBO->ID);
        }

        ?>" id="internalflight" name="internalflight">
        <table class="form-table">
            <tbody>
                <tr class="internalflight-post-title-wrap">
                    <th colspan="1">
                        <label for="post_title"><?php echo INTERNALFLIGHT_NAME_TITLE; ?> <span style="color: red;" class="description"><?php echo LABEL_REQUIRED; ?></span></label>
                    </th>
                    <td colspan="3">
                        <input type="text" class="large-text" value="<?php
                        if (isset($this->internalflightBO->post_title)) {
                            echo htmlspecialchars($this->internalflightBO->post_title);
                        }
                ...
                <tr class="internalflight-vote-times-wrap">
                    <th>
                    ...
                    <td>
                        ...
                        if (isset($this->internalflightBO->current_rating)) {
                            echo htmlspecialchars($this->internalflightBO->current_rating);
                        }
                    ...
                    <td>
                        ...
                        if (isset($this->internalflightBO->vote_times)) {
                            echo htmlspecialchars($this->internalflightBO->vote_times);
                        }
                ...
                <tr class="internalflight-country-id-wrap">
                        ...
                        <select id="country_id" name="country_id"  style="min-width: 150px;">
                            ...
                            if (isset($this->countryList) && is_a($this->countryList, "SplDoublyLinkedList")) {
                                ...
                                foreach ($this->countryList as $value) {
                                    ...
                                    ?>" <?php
                                            if (isset($this->internalflightBO->country_id) && $this->internalflightBO->country_id == $value->term_taxonomy_id) {
                            ...
                            ?>
                            <option value="0" <?php
                            if (isset($this->internalflightBO->country_id) && $this->internalflightBO->country_id == 0) {
                                echo "selected='selected'";
                            } elseif (!isset($this->internalflightBO->country_id)) {
                                echo "selected='selected'";
                            }
                    ...
                    <th><label for="city_id"><?php echo INTERNALFLIGHT_CITY_TITLE; ?> <span style="color: red;" class="description"><?php echo LABEL_REQUIRED; ?></label></th>
                    <td>
                        <select id="city_id" name="city_id"  style="min-width: 150px;">
                            ...
                            if (isset($this->cityList) && is_a($this->cityList, "SplDoublyLinkedList")) {
                                ...
                                foreach ($this->cityList as $value) {
                                    ...
                                    ?>" <?php
                                            if (isset($this->internalflightBO->city_id) && $this->internalflightBO->city_id == $value->term_taxonomy_id) {
                                                echo "selected='selected'";
                                            }
                            ...
                            ?>
                            <option value="0" <?php
                            if (isset($this->internalflightBO->city_id) && $this->internalflightBO->city_id == 0) {
                                echo "selected='selected'";
                            } elseif (!isset($this->internalflightBO->city_id)) {
                                echo "selected='selected'";
                            }
                ...
                <tr class="internalflight-image-wrap">
                    <th colspan="1">
                        <label for="image"><?php echo INTERNALFLIGHT_IMAGE_TITLE; ?> <span style="color: red;" class="description"><?php echo LABEL_REQUIRED; ?></label>
                    </th>
                    <td colspan="3">
                        <img width="96" height="96" class="avatar avatar-96 photo" srcset="<?php
                        if (isset($this->internalflightBO->image_url)) {
                            echo URL . htmlspecialchars($this->internalflightBO->image_url);
                        } else {
                        ...
                        <p class="images"><?php echo INTERNALFLIGHT_IMAGES_DESCRIPTION_DESC; ?></p>
                    </td>
                </tr>
                <tr class="internalflight-post-content-wrap">
                    <th colspan="1">
                        <label for="post_content"><?php echo INTERNALFLIGHT_CONTENT_TITLE; ?> <span style="color: red;" class="description"><?php echo LABEL_REQUIRED; ?></label>
                    </th>
                </tr>
                <tr class="internalflight-post-content-wrap">                    
                    <td colspan="4">
                        <textarea id="post_content" name="post_content" autocomplete="off" style="height: 200px;" class="wp-editor-area large-text" aria-hidden="true"><?php
                            if (isset($this->internalflightBO) && isset($this->internalflightBO->post_content)) {
                                echo htmlspecialchars($this->internalflightBO->post_content);
                            }
                ...
                <tr class="internalflight-tags-wrap">   
                    <th colspan="1">
                    ...
                    <td colspan="3">
                        ...
                        <div id="tagchecklist" class="tagchecklist">
                            <?php
                            if (isset($this->internalflightBO->tag_list) && count($this->internalflightBO->tag_list) > 0) {
                                $tagArray = array();
                                foreach ($this->internalflightBO->tag_list as $tag) {
                                    $tagArray[] = $tag->name;
        ...
        <p class="submit"><input type="submit" value="<?php echo LABEL_UPDATE_INTERNALFLIGHT; ?>" class="button button-primary" id="submit" name="submit"></p>
    </form>
    <script>
        window.scrollTo(0, 0);
        ...
        function validateFormEditInternalflight() {
            ...
            if (jQuery("#image").val() != "") {
                ...
                if (validExts.indexOf(fileExt) < 0) {
                    noticeError("<?php echo ERROR_INTERNALFLIGHT_IMAGE_INVALID; ?>");
                    return false;
                }
            }
            return true;
        ...
        jQuery("#form-your-profile").submit(function (e) {
            ...
            if (!validateFormEditInternalflight()) {
                return;
            }
            var name = jQuery('#form-your-profile input[name="post_title"]').val();
            if (confirm('<?php echo CONFIRM_EDIT_INFO_INTERNALFLIGHT; ?>' + name + '<?php echo CONFIRM_EDIT_INFO_CANCEL_OK; ?>')) {
