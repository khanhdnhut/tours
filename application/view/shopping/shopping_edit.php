...
if (isset($this->shoppingBO) && $this->shoppingBO != NULL) {
    ...
    <h1>
        <?php echo EDIT_PROFILE_OF_TITLE . " " . SHOPPING_TITLE; ?> "<strong><?php
            if (isset($this->shoppingBO->post_title)) {
                echo $this->shoppingBO->post_title;
            }

            ?></strong>"
        <a class="page-title-action" ajaxlink="<?php echo URL . CONTEXT_PATH_SHOPPING_ADD_NEW; ?>" ajaxtarget=".wrap" href="#" onclick="openAjaxLink(this)" ><?php echo ADD_NEW_TITLE; ?></a>
    </h1>
    ...
    <form id="form-your-profile" novalidate="novalidate"  method="POST" enctype="multipart/form-data" action="<?php echo URL . CONTEXT_PATH_SHOPPING_EDIT_INFO; ?>">
        <input type="hidden" value="update" name="action">
        <input type="hidden" value="<?php
        if (isset($this->shoppingBO->ID)) {
            echo htmlspecialchars($this->shoppingBO->ID);
        }
        ...
        <p class="submit"><input type="submit" value="<?php echo LABEL_UPDATE_SHOPPING; ?>" class="button button-primary" id="submit" name="submit"></p>
    </form>
    <script>
        window.scrollTo(0, 0);
        ...
        function validateFormEditShopping() {
        ...
        jQuery("#form-your-profile").submit(function (e) {
            ...
            if (!validateFormEditShopping()) {
                return;
            }
            var name = jQuery('#form-your-profile input[name="post_title"]').val();
            if (confirm('<?php echo CONFIRM_EDIT_INFO_SHOPPING; ?>' + name + '<?php echo CONFIRM_EDIT_INFO_CANCEL_OK; ?>')) {
