...
<h1>
    <?php echo ADD_NEW_STYLE_LABEL; ?>
</h1>
<div id="message_notice">
    <?php $this->renderFeedbackMessages(); ?>
</div>
<form id="form-your-profile" novalidate="novalidate"  method="POST" enctype="multipart/form-data" action="<?php echo URL . CONTEXT_PATH_STYLE_ADD_NEW; ?>">
        ...
        <tbody>
            ...
            <tr class="style-parent-wrap"><th><label for="parent"><?php echo STYLE_PERENT_TITLE; ?></label></th>
                <td>
                    ...
                    <span class="description"><?php echo STYLE_PERENT_DESC; ?></span>
                </td>
            </tr>
    ...
    <p class="submit"><input type="submit" value="<?php echo ADD_NEW_STYLE_LABEL; ?>" class="button button-primary" id="submit" name="submit"></p>
</form>
<script>
    window.scrollTo(0, 0);
    ...
    function validateFormAddNewStyle() {
    ...
    jQuery("#form-your-profile").submit(function (e) {
        ...
        if (!validateFormAddNewStyle()) {
            return;
        }
        var name = jQuery('#form-your-profile input[name="name"]').val();
        if (confirm('<?php echo CONFIRM_ADD_NEW_STYLE; ?>' + name + '<?php echo CONFIRM_EDIT_INFO_CANCEL_OK; ?>')) {
